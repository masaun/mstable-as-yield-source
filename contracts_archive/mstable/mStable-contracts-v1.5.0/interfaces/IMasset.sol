...
abstract contract IMasset is MassetStructs {
    ...
    /** @dev Calc interest */
    function collectInterest() external virtual returns (uint256 swapFeesGained, uint256 newTotalSupply);
    function collectPlatformInterest() external virtual returns (uint256 interestGained, uint256 newTotalSupply);
